...
public class GunScript : MonoBehaviour {
	...
	void Awake(){
		...
		//muzzelSpawn = GameObject.FindGameObjectWithTag("muzzleSpawn");
	...
	*/
	...
	void CrossHairExpansionWhenWalking(){
		...
		if(player.GetComponent<Rigidbody>().velocity.magnitude > 1 && Input.GetAxis("Fire1") == 0 || GunInventoryUI.revealed)
		{//ifnot shooting
	...
	*/
	...
	void Shooting(){
		...
		if (!meeleAttack&&!GunInventoryUI.revealed) {
